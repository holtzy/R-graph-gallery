...
descriptionMeta: "This post explains how to add a legend to a chart made with basic R, using the legend() function. It provides several reproducible examples with explanation and R code."
descriptionTop: "This post explains how to add a legend to a chart made with basic R, using the `legend()` function. It provides several reproducible examples with explanation and `R` code."
