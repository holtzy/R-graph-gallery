...
descriptionMeta: "Chord diagram is an efficient way to display flows between entities. This post shows how to build a customized version using the circlize package."
descriptionTop: "[Chord diagram](chord-diagram.html) is an efficient way to display flows between entities. This post shows how to build a customized version using the circlize package."
sectionText: "Chord section"
sectionLink: "chord-diagram.html"
DataToVizText: "Data to Viz"
DataToVizLink: "data-to-viz.com/graph/chord.html"
url: "122-a-circular-plot-with-the-circlize-package"
output:
  html_document:
...
The `circlize package` developped by [Zuguang Gu](https://github.com/jokergoo) is the best way to build [chord diagram](chord-diagram.html) in R. The chord diagram section of the gallery provides a step by step introduction to it. 
...
Note that the library also offers a `chordDiagram()` functions that builds everything automatically, but offers less customization. (See it [here](123-circular-plot-circlize-package-2).)
