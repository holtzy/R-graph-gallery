...
The resulting map is quite disapointing: China and India having very numerous population, all the variation between other countries gets hard to observe on the map.
...
It is a good practice to check the distribution of this variable to understand what kind of color scale should be used. Using a [histogram](hitsogram.html) is often a good option for that:
