...
```{r thecode, out.width = "100%", fig.height=7}
# The mtcars dataset:
...
```{r thecode2, out.width = "100%", fig.height=7}
...
```{r thecode4, out.width = c("30%","30%","30%"), fig.height=7, fig.show="hold"}
...
```{r thecode5, out.width = c("50%","50%"), fig.height=7, fig.show="hold"}
...
You can also change labels with `labRow`/`labCol` and their size with `cexRow`/`cexCol`.
...
```{r thecode6, out.width = "100%", fig.height=7}
