...
descriptionTop: "This post explains how to draw barplots with `R` and [ggplot2](ggplot2-package.html), using the `geom_bar()` function. It starts with the most basic example and describes a few possible customizations."
