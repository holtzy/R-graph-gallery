...
descriptionTop: "A [histogram](https://www.data-to-viz.com/graph/histogram.html) is a representation of the distribution of a numeric variable. This document explains how to build it with R and the [ggplot2 package](ggplot2.html). You can find more examples in the [histogram section](histogram.html."
