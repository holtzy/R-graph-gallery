...
url: "264-control-ggplot2-boxplot-colors.html"
output:
  html_document:
...
These for examples illustrate the most common color scales used in [boxplot](boxplot.com). 

Note the use of [RcolorBrewer](38-rcolorbrewers-palettes.html) and viridis to automatically generate nice color palette.
</div>
