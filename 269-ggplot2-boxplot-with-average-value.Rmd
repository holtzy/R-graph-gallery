...
descriptionTop: "A [boxplot](boxplot.html) summarizes the distribution of a continuous variable and notably displays the median of each group. This post explains how to add the value of the mean for each group with [ggplot2](ggplot2.html)."
...
[Ggplot2](ggplot2.html) allows to show the average value of each group using the `stat_summary()` function. No more need to calculate your mean values before plotting.
