...
descriptionTop: "This post provides reproducible code and explanation for the most basic [scatterplot](scatterplot.html) you can build with `R` and [ggplot2](ggplot2.html)."
