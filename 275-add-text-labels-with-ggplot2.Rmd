...
descriptionTop: "This document is dedicated to text annotation with [ggplot2](ggplot2.html). It provides several examples with reproducible code showing how to use function like `geom_label` and `geom_text`."
