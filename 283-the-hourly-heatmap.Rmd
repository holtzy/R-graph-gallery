...
descriptionTop: "A [heatmap](heatmap.html) used to display time series with R and [ggplot2](ggplot2-package.html). A submission by [John MacKintosh](http://johnmackintosh.com/) with reproducible code."
...
A submission by [John MacKintosh](http://johnmackintosh.com/) who visualized meteorological data using a heatmap built with [ggplot2](ggplot2-package.html). Initial code is stored on [github](https://gist.github.com/johnmackintosh/520643a1f82a0c7df00cf949ba98a4e9) and displayed below:
