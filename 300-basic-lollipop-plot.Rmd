...
descriptionTop: "How to build a very basic [lollipop chart](lollipop-plot.html) with `R` and [ggplot2](ggplot2.html). This post how to use `geom_point()` and `geom_segment()` based on different input formats."
