...
descriptionTop: "This post explains how to build a [bubble chart](bubble-chart.html) with R and [ggplot2](ggplot2.html). It provides several reproducible examples with explanation and R code."
...
With [ggplot2](ggplot2.html), bubble chart are built thanks to the `geom_point()` function. At least three variable must be provided to `aes()`: x, y and size. The legend will automatically be built by ggplot2.
