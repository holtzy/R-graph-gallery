...
This step has been extensively describe in [chart #325](325-background-map-from-geojson-format-in-r/). The `sf` library allows to read this type of format in R. For plotting it with `ggplot2`, the `geom_sf()` function allows to represent this type of object.
