...
- A numeric variable that we use to color each geographical unit. Here we will use the number of restaurant per city. The data has been found [here](https://www.insee.fr/fr/statistiques/2410933). (Thanks [@joelgombin](https://twitter.com/joelgombin)).
