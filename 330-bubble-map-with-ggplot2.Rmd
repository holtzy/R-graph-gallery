...
<img src="img/graph/330-bubble-map-with-ggplot2.png" alt="bubble map with R and ggplot2" width="100%"></img>
...
```{r thecode, out.width = c("50%","50%"), fig.show="hold", fig.height=6}
# Left chart
ggplot() +
...
```{r thecode5, out.width = c("33%","33%","33%"), fig.show="hold", fig.height=7}
