...
descriptionTop: "This post explains how to build a [bubble map](bubble-map.html) with [ggplot2](ggplot2.html). It takes a list of GPS coordinates and plot them on top of a map, with size and color mapped to data."
...
This post explains how to make a [bubble map](bubble-map.html) with [ggplot2](ggplot2.html). 
