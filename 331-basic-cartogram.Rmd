...
Let’s use [ggplot2](ggplot2.html) to add some color, title, legend, background and so on. We now have a nice cartogram chloropleth map of Africa!
...
Same thing with a tiny bit of customization. See more explanation in the [choropleth](choropleth.html) an [ggplot2](ggplot2.html) sections.
</div>
