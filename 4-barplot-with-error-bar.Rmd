...
descriptionTop: "This post describes how to add error bars on your [barplot](barplot.html) using R. Both [ggplot2](ggplot2.html) and base R solutions are considered. A focus on different types of error bar calculation is made."
