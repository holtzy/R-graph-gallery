...
descriptionMeta: "This post explains how to use the ggiraph package to create interactive graph and how to JavaScript to add additional effects for your ggplot interactive graphs."
descriptionTop: "This post explains how to use the [ggiraph](package/ggiraph.html) package to create **interactive graph** and how to **JavaScript** to add additional effects for your ggplot interactive graphs, with reproducible code and explanations.<br><br>For an introduction to `ggiraph`, check the [dedicated post](package/ggiraph.html)"
