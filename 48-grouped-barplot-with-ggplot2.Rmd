...
descriptionTop: "This post explains how to build grouped, stacked and percent stacked barplots with R and [ggplot2](https://www.r-graph-gallery.com/ggplot2-package.html). It provides a reproducible example with code for each type. Note that this [online course](https://datacamp.pxf.io/0Jd0RO) has a dedicated section on barplots using the <code>geom_bar()</code> function."
