...
descriptionTop: "Display the result of a linear model and its confidence interval on top of a [scatterplot](scatterplot.html). A [ggplot2](ggplot2-package.html) implementation with reproducible code."
