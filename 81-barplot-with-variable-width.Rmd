...
descriptionTop: "This post explains how to draw a [barplot](barplot.html) with variable bar width using R and [ggplot2](ggplot2-package.html). It can be useful to represent the sample size available behind each group."
