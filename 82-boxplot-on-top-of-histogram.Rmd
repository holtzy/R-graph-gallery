...
descriptionMeta: "How to display a boxplot on top of a histogram in Basic R."
...
This example illustrates how to split the plotting window in basic R thanks to the `layout function`. Contrary to the `par(mfrow=...)` solution, `layout()` allows greater control of panel parts.
