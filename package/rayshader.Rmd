...
descriptionTop: "The `rayshader` package in R is a powerful tool for creating beautiful shaded maps. This post explains how to use the package and showcases a set of graph examples."
...
`rayshader` provides a set of functions to create **beautiful shaded maps** in R.
