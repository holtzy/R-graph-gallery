...
descriptionTop: "It can be handy to include a [boxplot](boxplot.html) in the [violin plot](violin plot) to see both the distribution of the data and its summary statistics. Moreover, adding sample size of each group on the X axis is often a necessary step. Here is how to do it with <code>R</code> and [ggplot2](ggplot2.html)."
