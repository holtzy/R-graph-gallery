...
descriptionTop: "This is an extension of the classic [violin plot](violin plot.html). Here, data are organized in groups and subgroups, allowing to build a grouped violin chart. Chart is implemented using <code>R</code> and  the [ggplot2 library](ggplot2-package.html)."
