...
You can read more about the showtext package on this [dedicated post](https://r-graph-gallery.com/custom-fonts-in-R-and-ggplot2.html).
...
# Create the Plot
***
This chart is a [simple bar chart](https://www.r-graph-gallery.com/barplot.html). What might trip some R users up is the very minimal theme and the text labels because this chart employs methods that are far from the `ggplot` defaults. 
