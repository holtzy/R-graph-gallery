...
descriptionTop: "This guide demonstrates how to create an [area chart](area-chart.html) with **facetting**, which means the chart is divided by category. It explains how to customize the grid using [ggplot2](ggplot2-package). We will reference a chart by [Laura Navarro](https://laura-navarro-s.github.io/) that depicts **the proportion of people with covid-19 over time in Catalonia**."
