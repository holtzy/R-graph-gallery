...
descriptionMeta: "This post explains how to create a waffle chart for evolution with nice features such as annotations and others, using R and ggplot2. It provides a reproducible code and an explanation of it."
descriptionTop: "This post explains how to create a [waffle chart](https://r-graph-gallery.com/waffle.html) for evolution with nice features such as **annotations** and others, using R and [ggplot2](https://r-graph-gallery.com/ggplot2-package.html). It provides a reproducible code and an explanation of it."
...
<div style="text-align: center;">
  <img src="img/graph/web-waffle-for-time-evolution.png" alt="Waffle Chart" style="width: 100%; max-width: 600px; height: auto;">
</div>
